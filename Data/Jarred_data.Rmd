...
parcel_lc_2016 <- final_dataset %>%
  select(GlobalID, starts_with("Landcover_")) %>%
...
parcel_lc_2016 <- parcel_lc_2016 %>%
  rename("Open_Water" = "Landcover_11",
  "Developed_Open_Space" = "Landcover_21",
  "Developed_Low_Intensity" = "Landcover_22",
  "Developed_Medium_Intensity" = "Landcover_23",
  "Developed_High_Intensity" = "Landcover_24",
  "Barren_Land" = "Landcover_31",
  "Deciduous_Forest" = "Landcover_41",
  "Evergreen_Forest" = "Landcover_42",
  "Mixed_Forest" = "Landcover_43",
  "Shrub_Scrub" = "Landcover_52",
  "Grassland_Herbaceous" = "Landcover_71",
  "Pasture_Hay" = "Landcover_81",
  "Cultivated_Crops" = "Landcover_82",
  "Woody_Wetlands" = "Landcover_90",
  "Emergent_Herbaceous_Wetlands" = "Landcover_95"
)

library(dplyr)


parcel_lc_2016_no_geom <- st_set_geometry(parcel_lc_2016, NULL)

# View the final dataset
View(parcel_lc_2016)

write.csv(parcel_lc_2016_no_geom, "parcel_landcover_percentages_2016.csv", row.names = FALSE)
...
parcel_lc_2021_no_geom <- st_set_geometry(parcel_lc_2021, NULL)

write.csv(parcel_lc_2021_no_geom, "parcel_landcover_percentages_2021.csv", row.names = FALSE)
