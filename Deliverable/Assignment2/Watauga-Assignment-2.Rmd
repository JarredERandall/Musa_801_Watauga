...
```{r lc_2013, echo=FALSE, message=FALSE, warning=FALSE, fig.width= 10, fig.height=10}
rat2 <- ratify(lc_2013)
...
```{r lc_2016, echo=FALSE, message=FALSE, warning=FALSE, fig.width= 10, fig.height=10}
rat3 <- ratify(lc_2016)
...
```{r lc_2019, echo=FALSE, message=FALSE, warning=FALSE, fig.width= 10, fig.height=10}
rat4 <- ratify(lc_2019)
...
```{r lc_2021_2, echo=FALSE, message=FALSE, warning=FALSE, fig.width= 10, fig.height=10}
vals <-unique(s[[5]])  # Get unique values from lc_2021
df <- legend[legend$ID %in% vals,]  # Filter legend information based on lc_2021 values
rat5 <- ratify(lc_2021)
